...
from evspark.specdec.drafts import MASS_IDS, VOCAB_SIZE, IdentityDraftModel
...
def test_state_invariant_after_rejects(mini_model):
    ...
    from evspark.specdec.block.driver import diff_states, get_seqlen_offset, snapshot_states
