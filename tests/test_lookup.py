...
from evspark.specdec.harness import run_speculative
from evspark.specdec.lookup import (
    DEFAULT_LAMBDA,
    MASS,
    UNIFORM,
    VOCAB_SIZE,
...
from evspark.specdec.mock_models import _normalize_row, _normalize_rows
