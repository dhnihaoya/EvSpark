"""在线蒸馏循环 + 免解码评估 + 取层×宽度消融（单卡）。

用法::

    CUDA_VISIBLE_DEVICES=0 python -m evspark.train.distill --grid
"""
...
from evspark.specdec.markov import DEFAULT_ALPHA, MarkovDraftModel, MarkovTable
