...
用法::
    ...
    python -u scripts/train/fetch_ncbi_coding.py          # 全量抓取
    python -u scripts/train/fetch_ncbi_coding.py --only mycoplasma_genitalium  # 单物种试通
"""
...
from train.data import records_to_chunks
