...
from specdec.block.neural_draft import (  # noqa: E402
    HiddenCapture,
    NeuralDraftModel,
    serial_sample,
    trunk_forward,
)
from train.drafter import VOCAB_SIZE, Drafter  # noqa: E402
...
def test_mini_loop_neural_sampling_and_guards(mini_model):
    from specdec.block.driver import clone_inference_params
...
def test_mini_loop_external_prefill_aligned(mini_model):
    ...
    from specdec.block.driver import block_forward, prefill
    from specdec.block.loop import speculative_generate
    from test_block_forward import ACGTN_IDS, PREFIX_LEN
